...
# plt.title('MySpace: Number of Numeric Characters vs Score')
...
# plt.savefig('password_num_score_scatter.png')
...
plt.title('MySpace: Number of Numeric Characters vs Average Score')
plt.xlabel('Number of Numeric Characters')
...
# Save the plot as an image file
plt.savefig('num_avg_score_bar.png')
