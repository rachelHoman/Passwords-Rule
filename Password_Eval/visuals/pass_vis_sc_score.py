...
# with open('filtered_data_score.txt', 'r') as file:
#     # Read each line
...
# plt.title('MySpace: Number of Special Characters vs Score')
...
# plt.savefig('special_characters_score_scatter.png')
...
plt.title('MySpace: Number of Special Characters vs Average Score')
plt.xlabel('Number of Special Characters')
...
# Save the plot as an image file
plt.savefig('special_characters_avg_score_bar.png')
